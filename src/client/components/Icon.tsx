...
export const Icon = (iconObj: { className: string, iconSize: number}, entry: Models.IEntry) => {
	const defaultArrow = `<path fill="var(--fillColor, currentColor)" d="m34.11959,102.6673l-18.15083,-17.53097l31.75703,-30.64393l-31.75703,-30.64391l18.15083,-17.51581l49.91164,48.15972l-49.91164,48.1749z" transform="rotate(-90, 50, 54.5)"/>`
	const triangleArrow = `<polygon fill="var(--fillColor, currentColor)" points="50,0 100,100 0,100" />`
